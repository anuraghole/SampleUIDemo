 ...
 */
public class RecentActivityOthersFragment extends Fragment {
    RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;
    RecentActivityAdapter adapter;
    View view;

    public RecentActivityOthersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_recent_activity_others, container, false);
